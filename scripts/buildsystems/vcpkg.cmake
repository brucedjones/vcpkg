...
option(VCPKG_APPLOCAL_LIBRARY_DEPS "Automatically copy dependencies into the output directory for libraries." OFF)
...
function(add_library name)
    ...
    if(IMPORTED_IDX EQUAL -1 AND INTERFACE_IDX EQUAL -1 AND ALIAS_IDX EQUAL -1)
        get_target_property(_is_library_shared ${name} TYPE)
        if(VCPKG_APPLOCAL_LIBRARY_DEPS AND _VCPKG_TARGET_TRIPLET_PLAT MATCHES "windows|uwp" AND _is_library_shared STREQUAL "SHARED_LIBRARY")
            add_custom_command(TARGET ${name} POST_BUILD
                COMMAND powershell -noprofile -executionpolicy Bypass -file ${_VCPKG_TOOLCHAIN_DIR}/msbuild/applocal.ps1
                    -targetBinary $<TARGET_FILE:${name}>
                    -installedDir "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}$<$<CONFIG:Debug>:/debug>/bin"
